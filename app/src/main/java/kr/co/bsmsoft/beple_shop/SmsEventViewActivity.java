...
public class SmsEventViewActivity extends AppCompatActivity implements NetDefine, AdapterView.OnItemClickListener, View.OnClickListener, MessageManager.Callbacks {
    ...
    private TextView txtTitle, txtMessage, txtCount;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                    ...
                    task.mCallbacks = new AbServerTask.ServerCallbacks(){
                            ...
                            try {
                                ...
                                if (code == RESPONSE_OK) {
                                    ...
                                    if (event != null) {
                                        ...
                                        Helper.finishAlert("이벤트가 존재하지 않습니다.", SmsEventViewActivity.this);
                                    }
                                }else{
                                    Helper.finishAlert(EventTask.responseMessage(ret), SmsEventViewActivity.this);
                                }

                            } catch (JSONException e) {
                                Helper.finishAlert(e.getLocalizedMessage(), SmsEventViewActivity.this);
                                e.printStackTrace();
                            }
                        }
                        ...
                        public void onFailed(AbServerTask sender, int code, String msg) {
                            Helper.sweetAlert(getString(R.string.cannot_connect_server),
                                    ...
                                    SmsEventViewActivity.this);
                        }

                    };

                    task.getSmsEvent(eventId);
                    break;
                }
                case MSG_SEND_MESSAGE: {

                    // 메시지 내용
                    pDialog = new SweetAlertDialog(SmsEventViewActivity.this, SweetAlertDialog.PROGRESS_TYPE);
                    ...
                    messageManager = new MessageManager(msgBody, address, images, SmsEventViewActivity.this);
                ...
                case MSG_UPDATE_RESULT: {
                    ...
                    task.updateSmsEventResult(eventId);
                    break;
                }
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sms_event_view);
    ...
    private void setGridAdapter() {
        ...
        adapter = new PhotoGridViewAdapter(SmsEventViewActivity.this, imageList);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btnClose) {
            ...
            new SweetAlertDialog(SmsEventViewActivity.this, SweetAlertDialog.NORMAL_TYPE)
                    .setTitleText("알림")
