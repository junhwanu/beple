...
public class SmsEventListAdapter extends ArrayAdapter<EventModel> implements NetDefine {
    ...
    public SmsEventListAdapter(Context context, ArrayList<EventModel> data) {
        super(context, R.layout.cell_sms_list);
    ...
    private View createView(int position) {
        ...
        v = vi.inflate(R.layout.cell_sms_list, null);
