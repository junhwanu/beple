...
public class Settings {
    ...
    public Settings(String mmsc, String proxy, String port, boolean group, boolean wifiMmsFix,
                    ...
                    int sendLongAsMmsAfter, String account, String rnrSe, String mimetype) {
        this.mmsc = mmsc;
        this.proxy = proxy;
        this.port = port;
        this.userAgent = "";
     ...
     * @param rnrSe              is the token to use to send Google Voice messages (nullify if you don't know what this is)
     */
    public Settings(String mmsc, String proxy, String port, boolean group, boolean deliveryReports, boolean split, boolean splitCounter, boolean stripUnicode, String signature, String preText, boolean sendLongAsMms, int sendLongAsMmsAfter, String account, String rnrSe, String mimetype) {
        this(mmsc, proxy, port, group, false, deliveryReports, split, splitCounter, stripUnicode, signature, preText, sendLongAsMms, sendLongAsMmsAfter, account, rnrSe, mimetype);
    }
